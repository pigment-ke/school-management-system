<?php
session_start();
require('./config.php'); // Use the correct path to include the intended config file
class School extends Dbconfig {	
    public $hostName; // Changed from protected to public
    public $userName; // Changed from protected to public
    public $dbName;   // Changed from protected to public
